...
type Calculator interface {
	...
	//  - Logid
	//  - W
	Calculate(logid int32, w *Work) (r int32, ouch *InvalidOperation, err error)
...
//  - Logid
//  - W
func (p *CalculatorClient) Calculate(logid int32, w *Work) (r int32, ouch *InvalidOperation, err error) {
...
type CalculateResult struct {
	Success int32             `thrift:"success,0"`
	Ouch    *InvalidOperation `thrift:"ouch,1"`
}
